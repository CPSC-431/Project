...
<body>
    ...
    <div class="container my-4">
        <div class="jumbotron">
            ...
            <a class="btn btn-success btn-dark" href="home.php" role="button">Choose Another Category</a>
        </div>
    </div>

    <form method="post"> 
					<textarea name="post_content" rows="7" cols="64" style="" placeholder="Start a discussion" required></textarea>
					<br>
